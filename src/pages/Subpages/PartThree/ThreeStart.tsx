...
const ThreeStart: React.FC = () => {
    ...
    return (
      ...
      <button className="home" onClick={() => navigate('/mainmenupage')}>Back to Main Menu</button>
        ...
        <h2><br/>The year is 2158. The place is Scorchwood (formerly known as Norwich... before the bombs were dropped).<br/><br/>
...
When you were a little girl, your granny told you that before the One-Day War, back when the world was civilised, these utensils were used for eating. You always found it weird that a tool as versatile as the fork was only used in such a specific way.
