...
const OneQ1W: React.FC = () => {
    ...
    return (
      <div className="oneFont">
        ...
        <h2>You have always been committed to making environmentally friendly choices - you even convinced your parents to join you in becoming vegan... but wow, that burger sounds amazing.<br/><br/>
