...
const ThreeQ4W: React.FC = () => {
    ...
    return (
      ...
      <button className="home" onClick={() => navigate('/mainmenupage')}>Back to Main Menu</button>
        ...
        <h2>You immediately surrender, pleading with the raider not to hurt the grandchildren. After all, you are an old lady, what are you supposed to do - attack him?<br/><br/>
